...
#   funktion: recover package name (names_in: lista med user entered package names) 
#             -> names_out: lista med korrekta package names:
#
#       flatten list from "," to handle any user input
#       # for each package name in names_in:
#           # names_in += name.split(",")[1:]
#    
#
#       for name in names_in:
#           if name is package_name and not in_brackets:
#               if parts:
#                   names_out append string-join(parts)
#               parts = []
#
#           if opening bracket:
#               in_brackets -> True
#           if closing bracket and in_brackets:
#               in_brackets -> False
#           parts append (name)
#
#       names_out append string-join(parts)
...
#
#
#   funktion recover package names (lista med användargivna package name)
#       returnerar lista med validerade package namn           
#
#       om package namn i listan med angivna namn innehåller comma(n), 
#       lägg till de värdena separerade efter dem till listan
#
#       bygg upp validerade package namn:
#       format1:    namn
#       forma2t:    [part, part]
#       
#       för varje namn i användar listan:
#           om namnet bärjar med en bracket:
#               flagga in_brackets = True
#           om namnet slutar på en bracket och in_brackets är True
#               flagg in_brackets = False
#
#           om namnet är ett package namn och in_brackets är False:
#               om vi har parts:
#                   sätt ihop parts och lägg till dem i return-listan
#               resetta parts
# 
#           lätt till namnet i parts
#       lägg till kvarvarande parts i return-listan
#       returnerna listan
#
